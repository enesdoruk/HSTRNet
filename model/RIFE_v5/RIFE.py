...
from model.RIFE_v5.ddt import TransformerBlock
...
class FusionNet(nn.Module):
    def __init__(self):
        ...
        # self.ddt = nn.Sequential(*[TransformerBlock(dim=c, num_heads=1,
        #                                             num_groups=1, ffn_expansion_factor=2.66, 
        #                                             bias=False, LayerNorm_type='BiasFree', patch_size=[16,16],
        #                                             grid_size=[16,16], activate='gelu') for i in range(4)])
